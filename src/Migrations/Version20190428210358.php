...
final class Version20190428210358 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD date_last_login DATETIME NOT NULL, DROP username, DROP username_canonical, DROP email, DROP email_canonical, DROP salt, DROP password, DROP last_login, DROP confirmation_token, DROP password_requested_at');
    }
